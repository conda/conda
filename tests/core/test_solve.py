...
def test_determine_conflicting_specs_conflicts_upperbound():
    solution_prec = [
        PrefixRecord(
...
def test_determine_conflicting_specs_no_conflicts_upperbound_compound_depends():
    solution_prec = [
        PrefixRecord(
            package_type=PackageType.NOARCH_GENERIC, name="mypkg", version="0.1.1", channel="test", subdir="conda-test",
            fn="mypkg-0.1.1",
...
def test_determine_conflicting_specs_no_conflicts_version_star():
    solution_prec = [
        PrefixRecord(
            package_type=PackageType.NOARCH_GENERIC, name="mypkg", version="0.1.1", channel="test", subdir="conda-test",
            fn="mypkg-0.1.1",
...
def test_determine_conflicting_specs_no_conflicts_free():
    solution_prec = [
        PrefixRecord(
            package_type=PackageType.NOARCH_GENERIC, name="mypkg", version="0.1.1", channel="test", subdir="conda-test",
            fn="mypkg-0.1.1",
...
def test_determine_conflicting_specs_no_conflicts_no_upperbound():
    solution_prec = [
        PrefixRecord(
            package_type=PackageType.NOARCH_GENERIC, name="mypkg", version="0.1.1", channel="test", subdir="conda-test",
            fn="mypkg-0.1.1",
