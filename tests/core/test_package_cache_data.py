...
zlib_tar_bz2_prec = PackageRecord.from_objects(
    ...
    fn=zlib_tar_bz2_fn,
    url="{}/{}/{}".format(CONDA_PKG_REPO, subdir, zlib_tar_bz2_fn),
)
...
zlib_conda_prec = PackageRecord.from_objects(
    ...
    fn=zlib_conda_fn,
    url="{}/{}/{}".format(CONDA_PKG_REPO, subdir, zlib_conda_fn),
)
...
def test_instantiating_package_cache_when_both_tar_bz2_and_conda_exist():
    ...
    with make_temp_package_cache() as pkgs_dir:
        ...
        cache_action = CacheUrlAction(
            "{}/{}/{}".format(CONDA_PKG_REPO, subdir, zlib_tar_bz2_fn),
            pkgs_dir,
            zlib_tar_bz2_fn,
        )
        cache_action.verify()
        ...
        cache_action = CacheUrlAction(
            "{}/{}/{}".format(CONDA_PKG_REPO, subdir, zlib_conda_fn),
            pkgs_dir,
            zlib_conda_fn,
        )
        cache_action.verify()
