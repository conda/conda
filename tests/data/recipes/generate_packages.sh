...
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/another_dependent_v1
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/another_dependent_v2
...
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/dependent_v1
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/dependent_v2
...
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/feature_v1
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/feature_v2
...
# $RECIPES_DIR/small_python_package
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/small-executable
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/track_feature_v1
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/track_feature_v2
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/unsatisfiable --no-test
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/versioned_v1
conda build --output-folder $TEST_RECIPES_DIR $RECIPES_DIR/versioned_v2
