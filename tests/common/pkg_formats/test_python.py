...
def test_dist_get_paths():
    ...
    expected_output = [
        (join_url(sp_dir, "foo", "bar"), "0154c53d9a442b3b87afb3af4199a1694dcbbf02b3d3a009c3c993fe9361db22", 45),
...
def test_python_dist_info():
    test_files = (
        ("", "METADATA", "Name: zoom\nRequires-Python: ==2.7\nRequires-External: C\n"),
        ("", "RECORD", 'foo/bar,sha256=AVTFPZpEKzuHr7OvQZmhaU3LvwKz06AJw8mT\_pNh2yI,"45"\nfoo/spam,,\n'),
        ("", "INSTALLER", ""),
    )
    # Test mandatory files found
    temp_path, fpaths = _create_test_files(test_files)
