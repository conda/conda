...
class DefaultConfigChannelTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.DEFAULT_URLS = ['http://repo.continuum.io/pkgs/free/%s' % cls.platform,
                            'http://repo.continuum.io/pkgs/free/noarch',
                            'http://repo.continuum.io/pkgs/pro/%s' % cls.platform,
                            'http://repo.continuum.io/pkgs/pro/noarch']
        if on_win:
            cls.DEFAULT_URLS.extend(['http://repo.continuum.io/pkgs/msys2/%s' % cls.platform,
    ...
    def test_url_channel_w_platform(self):
        channel = Channel('http://repo.continuum.io/pkgs/free/osx-64')
        ...
        assert channel.base_url == 'http://repo.continuum.io/pkgs/free'
        assert channel.canonical_name == 'defaults'
        assert channel.url() == 'http://repo.continuum.io/pkgs/free/osx-64'
        assert channel.urls() == [
...
class CustomConfigChannelTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        migrated_custom_channels:
          ...
          pkgs/free: http://repo.continuum.io
        migrated_channel_aliases:
          - https://conda.anaconda.org
    ...
    def test_pkgs_free(self):
        ...
        channel = Channel('http://repo.continuum.io/pkgs/free')
        assert channel.channel_name == "pkgs/free"
        assert channel.channel_location == "192.168.0.15:8080"
        assert channel.canonical_name == "defaults"
        assert channel.urls() == [
        ...
        channel = Channel('http://repo.continuum.io/pkgs/free/noarch')
        assert channel.channel_name == "pkgs/free"
        assert channel.channel_location == "192.168.0.15:8080"
        assert channel.canonical_name == "defaults"
        assert channel.urls() == [
        ...
        channel = Channel('http://repo.continuum.io/pkgs/free/label/dev')
        ...
        channel = Channel('http://repo.continuum.io/pkgs/free/noarch/flask-1.0.tar.bz2')
        assert channel.channel_name == "pkgs/free"
        assert channel.channel_location == "192.168.0.15:8080"
    ...
    def test_pkgs_pro(self):
        ...
        channel = Channel('http://repo.continuum.io/pkgs/pro')
        assert channel.channel_name == "pkgs/pro"
        assert channel.channel_location == "repotest.continuum.io"
        assert channel.canonical_name == "defaults"
        assert channel.urls() == [
            'http://repo.continuum.io/pkgs/pro/%s' % self.platform,
            'http://repo.continuum.io/pkgs/pro/noarch',
        ]

        channel = Channel('http://repo.continuum.io/pkgs/pro/noarch')
        assert channel.channel_name == "pkgs/pro"
        assert channel.channel_location == "repotest.continuum.io"
        assert channel.canonical_name == "defaults"
        assert channel.urls() == [
        ...
        channel = Channel('http://repo.continuum.io/pkgs/pro/label/dev')
        assert channel.channel_name == "pkgs/pro/label/dev"
        assert channel.channel_location == "repotest.continuum.io"
        assert channel.canonical_name == "pkgs/pro/label/dev"
        assert channel.urls() == [
            'http://repo.continuum.io/pkgs/pro/label/dev/%s' % self.platform,
            'http://repo.continuum.io/pkgs/pro/label/dev/noarch',
        ]

        channel = Channel('http://repo.continuum.io/pkgs/pro/noarch/flask-1.0.tar.bz2')
        assert channel.channel_name == "pkgs/pro"
        assert channel.channel_location == "repotest.continuum.io"
        assert channel.platform == "noarch"
        assert channel.package_filename == "flask-1.0.tar.bz2"
