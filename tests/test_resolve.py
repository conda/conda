...
class TestSolve(unittest.TestCase):
    ...
    def test_iopro_nomkl(self):
        self.assertEqual(
            r.solve2(['iopro 1.4*', 'python 2.7*', 'numpy 1.7*'], returnall=True),
    ...
    def test_iopro_mkl(self):
        self.assertEqual(
            r.solve2(['iopro 1.4*', 'python 2.7*', 'numpy 1.7*', 'mkl@'], returnall=True),
            [['iopro-1.4.3-np17py27_p0.tar.bz2',
...
def test_pseudo_boolean():
    ...
    for alg in ['sorter', 'BDD']: #, 'BDD_recursive']:
        assert r.solve2(['iopro', 'python 2.7*', 'numpy 1.5*'], 
    ...
    for alg in ['sorter', 'BDD']: #, 'BDD_recursive']:
        assert r.solve2(['iopro', 'python 2.7*', 'numpy 1.5*', 'mkl@'],
            alg=alg, returnall=True) == [[
            'iopro-1.4.3-np15py27_p0.tar.bz2',
            'mkl-rt-11.0-p0.tar.bz2',
...
def test_generate_eq():
    ...
    groups = build_groups(r.get_dists(specs, filtered=False))
    ...
    eq, max_rhs = r.generate_version_eq(v, groups, specs, include0=True)
    ...
    assert e == [
         ...
         (8, u'dateutil-1.5-py26_0.tar.bz2'),
         (7, u'dateutil-1.5-py27_0.tar.bz2'),
         (6, u'dateutil-1.5-py33_0.tar.bz2'),
         ...
         (10, u'distribute-0.6.30-py26_0.tar.bz2'),
         (9, u'distribute-0.6.30-py27_0.tar.bz2'),
         (8, u'distribute-0.6.30-py33_0.tar.bz2'),
         (7, u'distribute-0.6.34-py26_0.tar.bz2'),
         (5, u'distribute-0.6.34-py26_1.tar.bz2'),
         (6, u'distribute-0.6.34-py27_0.tar.bz2'),
         ...
         (6, u'docutils-0.9.1-py26_0.tar.bz2'),
         (4, u'docutils-0.9.1-py26_1.tar.bz2'),
         (5, u'docutils-0.9.1-py27_0.tar.bz2'),
         (3, u'docutils-0.9.1-py27_1.tar.bz2'),
         ...
         (8, u'nose-1.1.2-py26_0.tar.bz2'),
         (7, u'nose-1.1.2-py27_0.tar.bz2'),
         (6, u'nose-1.1.2-py33_0.tar.bz2'),
         ...
         (96, u'numpy-1.5.1-py26_1.tar.bz2'),
         (88, u'numpy-1.5.1-py26_3.tar.bz2'),
         (80, u'numpy-1.5.1-py26_4.tar.bz2'),
         (104, u'numpy-1.5.1-py26_ce0.tar.bz2'),
         (92, u'numpy-1.5.1-py27_1.tar.bz2'),
         (84, u'numpy-1.5.1-py27_3.tar.bz2'),
         (76, u'numpy-1.5.1-py27_4.tar.bz2'),
         (100, u'numpy-1.5.1-py27_ce0.tar.bz2'),
         (64, u'numpy-1.6.2-py26_1.tar.bz2'),
         (56, u'numpy-1.6.2-py26_3.tar.bz2'),
         (48, u'numpy-1.6.2-py26_4.tar.bz2'),
         (72, u'numpy-1.6.2-py26_ce0.tar.bz2'),
         (60, u'numpy-1.6.2-py27_1.tar.bz2'),
         (52, u'numpy-1.6.2-py27_3.tar.bz2'),
         (44, u'numpy-1.6.2-py27_4.tar.bz2'),
         (68, u'numpy-1.6.2-py27_ce0.tar.bz2'),
         (20, u'numpy-1.7.0-py26_0.tar.bz2'),
         (16, u'numpy-1.7.0-py27_0.tar.bz2'),
         (12, u'numpy-1.7.0-py33_0.tar.bz2'),
         (40, u'numpy-1.7.0b2-py26_ce0.tar.bz2'),
         (36, u'numpy-1.7.0b2-py27_ce0.tar.bz2'),
         (32, u'numpy-1.7.0rc1-py26_0.tar.bz2'),
         (28, u'numpy-1.7.0rc1-py27_0.tar.bz2'),
         (24, u'numpy-1.7.0rc1-py33_0.tar.bz2'),
         (8, u'numpy-1.7.1-py26_0.tar.bz2'),
         (4, u'numpy-1.7.1-py27_0.tar.bz2'),
         ...
         (80, u'python-2.6.8-1.tar.bz2'),
         (76, u'python-2.6.8-2.tar.bz2'),
         (72, u'python-2.6.8-3.tar.bz2'),
         (68, u'python-2.6.8-4.tar.bz2'),
         (64, u'python-2.6.8-5.tar.bz2'),
         (60, u'python-2.6.8-6.tar.bz2'),
         (56, u'python-2.7.3-2.tar.bz2'),
         (52, u'python-2.7.3-3.tar.bz2'),
         (48, u'python-2.7.3-4.tar.bz2'),
         (44, u'python-2.7.3-5.tar.bz2'),
         (40, u'python-2.7.3-6.tar.bz2'),
         (36, u'python-2.7.3-7.tar.bz2'),
         (32, u'python-2.7.4-0.tar.bz2'),
         (28, u'python-2.7.5-0.tar.bz2'),
         (16, u'python-3.3.0-2.tar.bz2'),
         (12, u'python-3.3.0-3.tar.bz2'),
         (8, u'python-3.3.0-4.tar.bz2'),
         (24, u'python-3.3.0-pro0.tar.bz2'),
         (20, u'python-3.3.0-pro1.tar.bz2'),
         (4, u'python-3.3.1-0.tar.bz2'),
         (0, u'python-3.3.2-0.tar.bz2'),
         (8, u'pytz-2012d-py26_0.tar.bz2'),
         (7, u'pytz-2012d-py27_0.tar.bz2'),
         (6, u'pytz-2012d-py33_0.tar.bz2'),
         ...
         (20, u'scipy-0.11.0-np15py26_2.tar.bz2'),
         (13, u'scipy-0.11.0-np15py26_3.tar.bz2'),
         (26, u'scipy-0.11.0-np15py26_ce1.tar.bz2'),
         (19, u'scipy-0.11.0-np15py27_2.tar.bz2'),
         (12, u'scipy-0.11.0-np15py27_3.tar.bz2'),
         (25, u'scipy-0.11.0-np15py27_ce1.tar.bz2'),
         (18, u'scipy-0.11.0-np16py26_2.tar.bz2'),
         (11, u'scipy-0.11.0-np16py26_3.tar.bz2'),
         (24, u'scipy-0.11.0-np16py26_ce1.tar.bz2'),
         (17, u'scipy-0.11.0-np16py27_2.tar.bz2'),
         (10, u'scipy-0.11.0-np16py27_3.tar.bz2'),
         (23, u'scipy-0.11.0-np16py27_ce1.tar.bz2'),
         (16, u'scipy-0.11.0-np17py26_2.tar.bz2'),
         (9, u'scipy-0.11.0-np17py26_3.tar.bz2'),
         (22, u'scipy-0.11.0-np17py26_ce1.tar.bz2'),
         (15, u'scipy-0.11.0-np17py27_2.tar.bz2'),
         (8, u'scipy-0.11.0-np17py27_3.tar.bz2'),
         (27, u'scipy-0.11.0-np17py27_ce0.tar.bz2'),
         (21, u'scipy-0.11.0-np17py27_ce1.tar.bz2'),
         (14, u'scipy-0.11.0-np17py33_2.tar.bz2'),
         (7, u'scipy-0.11.0-np17py33_3.tar.bz2'),
         (6, u'scipy-0.12.0-np15py26_0.tar.bz2'),
         (5, u'scipy-0.12.0-np15py27_0.tar.bz2'),
...
def test_no_features():
    ...
    assert r.solve2(['python 2.6*', 'numpy 1.6*', 'scipy 0.11*', 'mkl@'],
        returnall=True) == [[
    ...
    assert r2.solve2(['pandas 0.12.0 np16py27_0', 'python 2.7*', 'mkl@'],
        returnall=True)[0] == [[
            'dateutil-2.1-py27_1.tar.bz2',
            'mkl-rt-11.0-p0.tar.bz2',           # This
...
def test_update_deps():
    installed = r.solve2(['python 2.7*', 'numpy 1.6*', 'pandas 0.10.1'])
    assert installed == [
        'dateutil-2.1-py27_1.tar.bz2',
        'numpy-1.6.2-py27_4.tar.bz2',
        'openssl-1.0.1c-0.tar.bz2',
    ...
    assert r.solve2(['pandas', 'python 2.7*'], installed=installed,
