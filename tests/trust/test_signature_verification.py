...
def _get_test_initial_trust_root():
    ...
    with open(test_1_root_json_location, 'r') as f:
        return json.load(f)
...
def test_trusted_root_no_new_metadata():
    ...
    with patch('conda.base.context.Context.av_data_dir', new_callable=PropertyMock) as av_data_dir_mock:
        av_data_dir_mock.return_value = tmp_rootdir.name
        with patch('conda.trust.signature_verification.INITIAL_TRUST_ROOT', new=_get_test_initial_trust_root()):
...
def test_trusted_root_2nd_metadata_on_disk_no_new_metadata_on_web():
    ...
    with patch('conda.base.context.Context.av_data_dir', new_callable=PropertyMock) as av_data_dir_mock:
        ...
        with patch('conda.trust.signature_verification.INITIAL_TRUST_ROOT', new=_get_test_initial_trust_root()):
            ...
            with open(test_2_root_dest, 'r') as f:
...
def test_2nd_root_metadata_from_web():
    ...
    with patch('conda.base.context.Context.av_data_dir', new_callable=PropertyMock) as av_data_dir_mock:
        ...
        with patch('conda.trust.signature_verification.INITIAL_TRUST_ROOT', new=_get_test_initial_trust_root()):
            ...
            with open(testdata_2_root, 'r') as f:
                test_2_root_data = json.load(f)
...
def test_3rd_root_metadata_from_web():
    ...
    with patch('conda.base.context.Context.av_data_dir', new_callable=PropertyMock) as av_data_dir_mock:
        ...
        with patch('conda.trust.signature_verification.INITIAL_TRUST_ROOT', new=_get_test_initial_trust_root()):
            ...
            with open(testdata_3_root, 'r') as f:
