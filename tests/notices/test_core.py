...
def test_notices_decorator(capsys, notices_cache_dir, notices_mock_fetch_session_manager):
    """
...
def test__conda_user_story__disable_notices(
    capsys, notices_cache_dir, notices_mock_fetch_session_manager, disable_channel_notices
):
    """
