...
from conda.base.constants import CONDA_TARBALL_EXTENSION_V1, PACKAGE_CACHE_MAGIC_FILE, SafetyChecks, \
    ...
    def test_create_from_extracted(self):
        with make_temp_package_cache() as pkgs_dir:
            ...
            def pkgs_dir_has_tarball(tarball_prefix):
                return any(f.startswith(tarball_prefix) and f.endswith(CONDA_TARBALL_EXTENSION_V1)
