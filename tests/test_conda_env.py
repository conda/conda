...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("conda_env.env.load_from_directory", None),
        ...
        ("conda_env.pip_util.get_pip_version", None),
        ("conda_env.pip_util.PipPackage", None),
        ("conda_env.pip_util.installed", None),
        ("conda_env.pip_util._canonicalize_regex", None),
        ("conda_env.pip_util._canonicalize_name", None),
        ("conda_env.pip_util.add_pip_installed", None),
        (
