...
from ..base.constants import CONDA_TARBALL_EXTENSION_V1, PREFIX_MAGIC_FILE
...
class PrefixData(object):
    ...
    def insert(self, prefix_record):
        ...
        assert prefix_record.fn.endswith(CONDA_TARBALL_EXTENSION_V1)
        filename = prefix_record.fn[:-len(CONDA_TARBALL_EXTENSION_V1)] + '.json'
