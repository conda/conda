...
# if repodata_shards.msgpack.zst or repodata.json.zst were unavailable, check again later.
...
def get_repo_interface() -> type[RepoInterface]:
    """Return the appropriate RepoInterface class for fetching repodata.

    Note: JLAP support has been removed. Shard-based functionality provides
    incremental updates. This function now always returns CondaRepoInterface.
    """
