...
from .widgets import format_updatable
...
class Bar(object):
    ...
    def __init__(
            self, term=None, max_value=100, width="80%", title_pos="left",
            ...
            force_color=None, widgets=None, new_line=False, enable_color=True
    ):
        ...
        self.widgets_length = 20 if self.widgets else 0
        ...
        while not self.full_line_width <= self.columns:
            self._width_str = "{}{}".format(floor(float(self._width_str[:-1])-10), width[-1])
    ...
    def _measure_terminal(self):
        self.lines, self.columns = (
            ...
            self.term.width or self._env_size()
        )
    ...
    def _format_line(self):
        ...
        self.widgets_length = len(widgets)
    ...
    def draw(self, value, newline=True, flush=True):
        ...
        # before write rhe bar rjust the progress bae
