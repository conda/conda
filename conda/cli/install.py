...
from ..misc import _get_best_prec_match, clone_env, install_explicit_packages, get_package_record_from_explicit
...
def _assemble_environment(
    ...
    explicit_packages = get_package_record_from_explicit(fetch_explicit_packages)
