...
from ..exceptions import CondaEnvironmentNotFoundError, CondaHistoryError, CondaIOError, CondaImportError, \
    CondaSystemExit, CondaValueError, DirectoryNotFoundError, DryRunExit, LockError, NoPackagesFoundError, \
    PackageNotFoundError, TooManyArgumentsError, UnsatisfiableError, CondaOSError
        ...
        with common.json_progress_bars(json=context.json and not context.quiet):
            try:
                ...
                if len(e.args) > 0 and "LOCKERROR" in e.args[0]:
                    ...
                    raise CondaHistoryError('HistoryError: %s' % e)
