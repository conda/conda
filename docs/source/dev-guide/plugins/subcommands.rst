...
Subcommands can provide an alias or aliases for alternate command names. Aliases
are registered with the same parser and action as the primary subcommand name,
and must not overlap with built-in commands or other plugin subcommands.
