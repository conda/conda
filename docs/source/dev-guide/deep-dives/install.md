...
together in a `PrefixActionGroup`. These are then passed to `.verify()`. This method
...
[`PrefixActionGroup`][conda.core.link:PrefixActionGroup].
...
[conda.core.link:PrefixActionGroup]: https://github.com/conda/conda/blob/26.3.x/conda/core/link.py#L229
