...
description is also available in {doc}`/dev-guide/implementation-notes/solver-state`.
...
[current implementation][conda.cli.install:revert_actions] can be considered broken. Once fixed,
...
{doc}`solver state technical specification </dev-guide/implementation-notes/solver-state>`, but here's a little
...
[conda.cli.install:revert_actions]: https://github.com/conda/conda/blob/24.5.0/conda/cli/install.py#L458-L493
