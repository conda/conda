...
As of version ``X.Y``, conda has support for user plugins, enabling them to extend and/or
change some of its functionality.

Plugins are implemented via pluggy_ and discovered using
`Python package entrypoints`_. You may refer to pluggy_'s documentation
