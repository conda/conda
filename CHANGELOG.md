...
* Add `conda.core.index.Index` as a faster drop-in replacement of the realized dictionary index. (#13880, #14267)

  Note: This removes the implicit initialization of the logging from `get_index`. If you relied on that, you should probably call `conda.gateways.logging.initialize_logging` explicitly.
...
* Postpone `conda.base.context.Context.conda_exe` to `conda 25.3`. (#14077)
* Postpone `conda.cli.python_api` to `conda 25.9`. (#14077)
