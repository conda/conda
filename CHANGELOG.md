...
* Mark `conda_exe` in `context.py` and a topic in `print_package_info` `cli/command/main_info.py` for official deprecation. (#12398)
...
* Mark `conda_exe` in `context.py` and a topic in `print_package_info` `cli/command/main_info.py` for official deprecation. (#12276)
...
* Reorganize and new tests for `conda.cli.command.main_clean` (#11360)
